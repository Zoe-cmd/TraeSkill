...
| 文档 | 文件路径 | 说明 |
|------|----------|------|
| 产品需求文档 | `docs/产品需求文档.md` | PRD，由产品经理产出 |
| 架构设计文档 | `docs/架构设计文档.md` | 架构设计，由系统架构师产出 |
| API 规范文档 | `docs/API规范文档.md` | API 设计，由后端工程师产出 |
| 数据库设计文档 | `docs/数据库设计文档.md` | 数据库 Schema，由数据库工程师产出 |
| 数据库迁移计划 | `docs/数据库迁移计划.md` | 迁移脚本说明，由数据库工程师产出 |
| 设计系统文档 | `docs/设计系统.md` | UI 设计规范，由 UI/UX 设计师产出 |
| 测试计划 | `docs/测试计划.md` | 测试策略和用例，由测试工程师产出 |
| 测试报告 | `docs/测试报告.md` | 测试结果，由测试工程师产出 |
| 缺陷报告 | `docs/缺陷报告.md` | Bug 列表和详情，由测试工程师产出 |
| 代码审查报告 | `docs/代码审查报告.md` | 审查结果，由代码评审工程师产出 |
| 重构建议 | `docs/重构建议.md` | 重构方向，由代码评审工程师产出 |
| 部署计划 | `docs/部署计划.md` | 部署方案，由运维工程师产出 |
| 决策日志 | `docs/决策日志.md` | 技术决策记录，由各角色共同维护 |
| 项目计划 | `docs/项目计划.md` | 项目规划，由项目经理产出 |
| 任务清单 | `docs/任务清单.md` | Todo 列表，由项目经理维护 |

### 交接文档命名

| 文档 | 文件路径格式 | 说明 |
|------|-------------|------|
| 阶段交接文档 | `docs/交接-{源角色}-to-{目标角色}.md` | 例如：`docs/交接-产品经理-to-系统架构师.md` |
| 缺陷修复交接 | `docs/缺陷修复交接-{BUG-ID}.md` | 例如：`docs/缺陷修复交接-BUG-010.md` |
