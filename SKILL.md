...
> **缺陷修复回路**：当 QA/安全工程师/代码评审工程师在 Phase 4-5 发现 Critical/High 问题时，不得直接交接给下游角色，必须触发缺陷修复回路。详见 `roles/qa-engineer.md`、`roles/security-engineer.md`、`roles/code-reviewer.md` 中的「缺陷修复回路」章节。
